 ...
 */
public class Australia extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
...
//        pDialog.show();
        ...
        Call<JsonResponse> call = request.getJSON1();
...
//                        pDialog.dismiss();
            ...
            public void onFailure(Call<JsonResponse> call, Throwable t) {
                try{Log.d("Error2", "no connection");
                swipe.setRefreshing(false);}
                catch(Exception e){}
            }
        });
